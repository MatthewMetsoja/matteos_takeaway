        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <div class="alert-danger"> <?= $msg['nut_traces'] ?></div>
                    No <input type="radio" <?php  
                        if(isset($this->old_nut_traces) && $this->old_nut_traces == "0" ) {echo "checked";} 
                        elseif(isset($nut_traces) && $nut_traces == "0"){echo "checked";} ?> 
                        value="0" name="nut_traces" id="inputName">    &nbsp; &nbsp; 
                    
                    Yes <input type="radio" <?php  
                        if(isset($this->old_nut_traces) && $this->old_nut_traces == "1" ) {echo "checked";} 
                        elseif(isset($nut_traces) && $nut_traces == "1"){echo "checked";} ?> 
                        value="1" name="nut_traces" id="inputName">
            </div>
        </div>
